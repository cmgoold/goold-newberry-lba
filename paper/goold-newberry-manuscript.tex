...
\begin{figure}[t!]
  ...
  \begin{subfigure}{1\textwidth}
    \centering
    \includegraphics[scale=0.23]{figure_4_a.png}
  \end{subfigure}
  %
  \begin{subfigure}{1\textwidth}
    \centering
    \vspace{-0.6cm}
    \includegraphics[scale=0.23]{figure_4_b.png}
  \end{subfigure}
  %
  \begin{subfigure}{1\textwidth}
    \centering
    \vspace{-0.6cm}
    \includegraphics[scale=0.23]{figure_4_c.png}
  \end{subfigure}
  %
  \begin{subfigure}{1\textwidth}
    \centering
    \vspace{-0.6cm}
    \includegraphics[scale=0.23]{figure_4_d.png}
  \end{subfigure}%
